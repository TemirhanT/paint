...
const Zoom: FC = memo(({ zoomIn, zoomOut, centerView, resetTransform }: any) => {
    ...
    return ( 
        <div className="zoom">
            <img src="/paint/Assets/zoom-in.png" onClick={() => customZoomIn()}/>
            <img src="/paint/Assets/zoom-out.png" onClick={() => customZoomOut()}/>
            <img src="/paint/Assets/reset.png" onClick={() => customReset()}/>
