...
import { drawTriangle } from "./Triangle";
    ...
    // 
    //*почему то сейчас отрисовка не лагает и все выглядит очень плавно, хотя сейчас массив координат больше в разы чем в прошлый раз. С чем это связано не знаю
    //
